...
## Project Structure
    ...
    ├── testapiautodatamod_126670  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_126670`
...
2. Clone this repo and `cd testapiautodatamod_126670`
